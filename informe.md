...
**Parcial N°2 — Análisis de Datos COM3**  
...
**Cantidad de tipos de vehiculo:** 839 tipos distintos (antes 995, se corregieron 156 tipos que representaban lo mismo pero con errores de escritura o variaciones en el nombre)
**Cantidad de marcas de vehiculo:** 338 marcas distintas (antes 473, se corrigieron 135 marcas que representaban lo mismo pero con errores de escritura o variaciones en el nombre)
...
|----------|------|---------------|
| 1° | SEDAN 5 PUERTAS | 55.832 |
| 2° | SEDAN 4 PUERTAS | 34.582 |
| 3° | PICK-UP | 19.078 |
| 4° | SEDAN 3 PUERTAS | 13.321 |
| 5° | RURAL 5 PUERTAS | 12.542 |

**El tipo de automotor más transferido es el SEDAN 5 PUERTAS**, con 55.832 transferencias, representando el **32,85%** del total del dataset. El dominio de los sedán de cinco puertas es contundente: más que duplica al segundo tipo más transferido.
...
**VOLKSWAGEN es la marca con mayor cantidad de transferencias**, con 30.263 unidades, representando el **17.82%** del total. Cabe destacar que tras la eliminación de outliers, CHEVROLET superó a RENAULT en el tercer puesto respecto al análisis preliminar sin filtrar.
...
|-----------|-------------|---------------|
| Buenos Aires | VOLKSWAGEN | 12.277 |
| Córdoba | VOLKSWAGEN | 3.110 |
| CABA | VOLKSWAGEN | 2.329 |
| Santa Fe | VOLKSWAGEN | 2.147 |
| Mendoza | VOLKSWAGEN | 1.321 |
| Entre Ríos | VOLKSWAGEN | 1.368 |
| Neuquén | VOLKSWAGEN | 859 |
| Río Negro | VOLKSWAGEN | 622 |
| Tucumán | VOLKSWAGEN | 681 |
| Corrientes | VOLKSWAGEN | 662 |
| Chubut | **FORD** | 582 |
...
|-----------|------------|---------------|
| Buenos Aires | SEDAN 5 PUERTAS | 21.844 |
| Córdoba | SEDAN 5 PUERTAS | 6.509 |
| CABA | SEDAN 5 PUERTAS | 5.850 |
| Santa Fe | SEDAN 5 PUERTAS | 4.569 |
| Mendoza | SEDAN 5 PUERTAS | 2.397 |
| Entre Ríos | SEDAN 5 PUERTAS | 2.025 |
| Neuquén | SEDAN 5 PUERTAS | 1.377 |
| Tucumán | SEDAN 5 PUERTAS | 1.200 |
| Río Negro | SEDAN 5 PUERTAS | 1.102 |
| Corrientes | SEDAN 5 PUERTAS | 910 |
| Chubut | SEDAN 5 PUERTAS | 937 |
| Chaco | SEDAN 5 PUERTAS | 812 |
